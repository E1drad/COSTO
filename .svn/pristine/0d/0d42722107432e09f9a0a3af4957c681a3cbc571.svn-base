...
public class SimpleVehicle_speedLTS extends ExecutableLTS {

private SimpleVehicle_speed service;

public void setService(SimpleVehicle_speed theservice){
...
transitionLabels.put("i___f___1","__CALLER!!speed(vspeed)");
