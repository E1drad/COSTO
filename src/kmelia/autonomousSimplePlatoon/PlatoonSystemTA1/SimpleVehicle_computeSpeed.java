...
import static kmelia.autonomousSimplePlatoon.PlatoonSystemTA1.PLATOONLIB.distanceStep;
...
//
 ...
 Boolean anonymous948Pre(){
Boolean resultA;
resultA=getSafeDistance() >= 0;
this.assertStatus("anonymous948Pre()",resultA.toString());
return resultA;
}
//
