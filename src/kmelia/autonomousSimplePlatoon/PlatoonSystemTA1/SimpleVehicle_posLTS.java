...
public class SimpleVehicle_posLTS extends ExecutableLTS {

private SimpleVehicle_pos service;

public void setService(SimpleVehicle_pos theservice){
...
transitionLabels.put("i___f___1","__CALLER!!pos(lastpos)");
