...
this.outGoing.put("checkSD0", createArrayListFrom(  "checkSD0___checkgoal0___3" ));
...
transitionLabels.put("checkSD0___checkgoal0___3","safeDist := !!safeDistance");
...
transitionCommunications.put("checkSD0___checkgoal0___3",new SimpleCommunication("safeDistance",null,"_safeDistance",1));
...
if ("checkSD0___checkgoal0___3".equals(transition)) return this.service.guard_checkSD0___checkgoal0___3();
...
if ("checkSD0___checkgoal0___3".equals(transition))  {this.service.checkSD0___checkgoal0___3();return;}
