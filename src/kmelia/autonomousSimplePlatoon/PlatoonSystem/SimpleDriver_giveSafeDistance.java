...
public  class SimpleDriver_giveSafeDistance extends ProvidedService {
// component owner
...
public void initLTS(){
SimpleDriver_giveSafeDistanceLTS lts=new SimpleDriver_giveSafeDistanceLTS();
this.setLTS(lts);
lts.setService(this);
lts.init();
}
...
result.append(".SimpleDriver_giveSafeDistance: [");
...
//msg("Driver give safedistance")
 
 @KmlElement(type={KmlElementType.TRANSITION})
 void i___i1___1(){
 mylib.PlatoonlibMap.msgFrom("Driver give safedistance",this);
}
//SENDRESULT(10)
